...
const services = [
  ...
  },
  {
    ...
    technologies: ["Node.js", "NestJS", "PostgreSQL", "AWS", "Docker"],
  ...
  },
  {
    ...
    technologies: ["React Native", "Kotlin", "TypeScript", "Firebase"],
    gradient: "from-orange-500 to-amber-500",
    gradientBg: "from-orange-500/20 via-orange-500/10 to-transparent",
  ...
  },
  {
    ...
    description:
      "Intelligent solutions powered by AI and machine learning to drive business insights and automation.",
    features: [
